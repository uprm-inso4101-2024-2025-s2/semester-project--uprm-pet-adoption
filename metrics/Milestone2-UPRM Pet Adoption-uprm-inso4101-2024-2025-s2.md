...
|   "message": "You have exceeded a secondary rate limit. Please wait a few minutes before you try again. If you reach out to GitHub Support for help, please include the request ID 1802:21FF16:ED96ED:1DD9CD2:681EA09A." |
| } |
...
|                    ^^^^^^^^^^^^^^^^^^^^^^^^^^^ |
|   File "/home/runner/work/semester-project--uprm-pet-adoption/semester-project--uprm-pet-adoption/inso-gh-query-metrics/src/generateTeamMetrics.py", line 477, in getTeamMetricsForMilestone |
|     for issue in getIteratorFromQueue(issueMetricsQueue): |
|   File "/home/runner/work/semester-project--uprm-pet-adoption/semester-project--uprm-pet-adoption/inso-gh-query-metrics/src/generateTeamMetrics.py", line 376, in queueIteratorNext |
|     raise value |
|   File "/home/runner/work/semester-project--uprm-pet-adoption/semester-project--uprm-pet-adoption/inso-gh-query-metrics/src/generateTeamMetrics.py", line 358, in iteratorSplitter |
|     for item in iterator: |
|   File "/home/runner/work/semester-project--uprm-pet-adoption/semester-project--uprm-pet-adoption/inso-gh-query-metrics/src/generateTeamMetrics.py", line 234, in fetchProcessedIssues |
|     for issue_dict in fetchIssuesFromGithub(org=org, team=team, logger=logger): |
|   File "/home/runner/work/semester-project--uprm-pet-adoption/semester-project--uprm-pet-adoption/inso-gh-query-metrics/src/generateTeamMetrics.py", line 186, in fetchIssuesFromGithub |
|     response: dict = runGraphqlQuery(query=get_team_issues, variables=params) |
|                      ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^ |
|   File "/home/runner/work/semester-project--uprm-pet-adoption/semester-project--uprm-pet-adoption/inso-gh-query-metrics/src/utils/queryRunner.py", line 63, in runGraphqlQuery |
